...
const UploadExpenses: React.FC<Props> = ({ setIsOpen }) => {
      ...
      <div className="h-full w-full flex flex-col overflow-y-scroll pb-4">
        ...
        <div className="flex flex-col items-start px-4 space-y-4 mt-14">
          <div className="flex justify-center items-center w-full">
            <label
              ...
              className="flex flex-col justify-center items-center w-full h-64 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600 mt-2"
            >
          ...
          {error.length > 0 && (
            <span className="font-md text-red-600 font-bold">
              Error: {error}
            </span>
          )}
        </div>
        {data.length > 0 && (
          <div className="flex flex-col mt-8 px-4">
            <h2 className="font-bold mb-4 text-lg md:text-xl self-start">
              Imported Data
            </h2>
